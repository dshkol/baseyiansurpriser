...
```{r plot-income-surprise, fig.width=10, fig.height=8}
...
```{r housing-surprise, fig.width=9, fig.height=7}
...
```{r language-surprise, fig.width=9, fig.height=7}
# Compute surprise - use uniform and baserate only for local CMA analysis
